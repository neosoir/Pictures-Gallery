...
class BCPG_Widget extends WP_Widget {
    
    public function __construct() {
        
        $widget_options = [
            'classname'     => 'bcpg-widget',
        ...
        parent::__construct( 'bcpg-widget', __('Mi Widget Personalizado', 'miprimerplugin'), $widget_options, $control_options  );
